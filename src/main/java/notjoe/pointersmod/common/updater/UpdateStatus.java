...
public class UpdateStatus {
    ...
    public UpdateStatus(String releaseChannel, String latestAlpha, String latestBeta,
    ...
    public String getLatestReleaseCurrentChannel() {
        if (releaseChannel.equals("alpha"))
            return latestAlpha;
        if (releaseChannel.equals("beta"))
            return latestBeta;
        if (releaseChannel.equals("release"))
    ...
    public List<String> getUpdateMessages() {
        if (isLatestVersion) {
        ...
        } else if (getLatestReleaseCurrentChannel().equals("") || getLatestReleaseCurrentChannel()
            .equals("Unknown")) {
            ...
            return Arrays.asList(String.format("A new version of pointers is available! %s",
                getLatestReleaseCurrentChannel()),
