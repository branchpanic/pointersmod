...
public class ItemPointerBase extends ModItem {
    ...
    public void addInformation(ItemStack stack, EntityPlayer playerIn, List<String> tooltip,
        ...
        if(pointerAction.hasTarget(stack)) {
            ...
            tooltip.add(I18n.format("pointers.blockpos", blockInWorld.pos.getX(), blockInWorld.pos.getY(), blockInWorld.pos.getZ()));
    ...
    public IItemHandler getStackHandlerFromPointer(ItemStack stack, World world, EntityPlayer player) {
